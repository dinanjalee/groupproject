				...
				<div class="wrap">
					<section class="col-1-3"><div class="wrap-col">
						<div class="box">
							<div>
								<br>
								<img src="<?php echo base_url('images/mamas.jpg');?>"/>
								<h2>Mama's <span>Kitchen</span></h2>
								<ul class="list1 pad_bot1">
									<br>
									<li><a href="#">A2,   Wadduwa</a></li>
									<li><a href="#">011-2545714</a></li>
									<br>
									<li><a href="#">Cost for two : Rs.1800 </a></li>
									<br>
					...
					<section class="col-3-3"><div class="wrap-col">
						...
						<ul class="list1 pad_bot1">
									<li><a href="#">Mama's kitchen is our recently opened, smaller outlet – located at Wadduwa.It serves up a predominantly vegan and vegetarian menu, with a focus on locally sourced produce.</a></li> 
