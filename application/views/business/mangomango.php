				...
				<div class="wrap">
					<section class="col-1-3"><div class="wrap-col">
						<div class="box">
							<div>
								<br>
								<img src="<?php echo base_url('images/mango_1.jpg');?>"/>
								<h2>Mango <span>Mango</span></h2>
								<ul class="list1 pad_bot1">
									<br>
									<li><a href="#">74   Galle Rd<br>Panadura</a></li>
									<li><a href="#">011-2520314</a></li>
									<br>
									<li><a href="#">Cost for two : Rs.2000 </a></li>
									<br>
					...
					<section class="col-3-3"><div class="wrap-col">
						...
						<ul class="list1 pad_bot1">
									<li><a href="#">Mango Mango is our recently opened, smaller outlet – located at Panadura.It serves up a predominantly vegan and vegetarian menu, with a focus on locally sourced produce.</a></li> 
