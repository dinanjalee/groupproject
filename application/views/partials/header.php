    ...
    <body>
        <div id="main">
            <nav>
                ...
                <img src="<?php echo base_url() ?>assets/images/logo/logo3.png" width="200" height="70">
                ...
                <ul >
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url() ?>index.php/Home/restaurant">Restaurants</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url() ?>index.php/Home/registration">Registration</a>
                    </li>
                    <li class="nav-item">
